...
<body>
  <?php include "header.php"; ?>
    ...
    <div class="rts-breadcrumb-area" style="background-image: url('custom/asset-tracking.png');">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    <div class=" rts-section-gapBottom">
        <div class="container">
            <div class="row">
            <div class="col-lg-12">
    <p>Now, when a nurse needs an infusion pump, instead of running from ward to ward, they simply check the BiGRABiT dashboard and see: “2 pumps available in Ward B, 1 in ICU, 1 in Maintenance.” The equipment is found within seconds, saving time and improving patient care.</p>

    <p>The same solution works in factories and warehouses. Tools can be misplaced, and shipments can get delayed if pallets aren’t found. With BiGRABiT, every pallet or tool has a digital identity. If something moves out of a designated zone, managers get an instant alert—preventing theft, misplacement, and downtime.</p>

    <p>In retail stores, shelves with beacon tags help track stock movement. Store managers instantly know when an item is low or missing, avoiding lost sales due to empty shelves.</p>

    <p>With BiGRABiT’s Asset Tracking, businesses stop losing time and money searching for critical items. Instead, they gain a real-time map of their assets, turning daily chaos into smooth, efficient operations.</p>
            </div>
