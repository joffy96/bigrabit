            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="header-main-one-wrapper">
                        <div class="thumbnail">
                            <a href="index">
                                <img src="assets/images/logo/bigrabit.png" style="width: 25%;" alt="finbiz-logo">
                            </a>
                        </div>
                        ...
                        <div class="row g-0">
                            <div class="col-lg-3">
                                <ul class="mega-menu-item with-list parent-nav">
                                    ...
                                    <li><a href="index"><i class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Business One</a></li>
                                    <li><a href="index-two"><i class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Business Two</a></li>
                                    <li><a href="index-three"><i class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Business Three</a></li>
                                    <li><a href="index-four"><i class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Business Four</a></li>
                                    <li><a href="index-five"><i class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Finance Demo</a></li>
                                    <li><a href="index-six"><i class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Marketing agency</a></li>
                                    <li><a href="index-thirteen">
                                            <i class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Accountent One
                                            <span class="new-badge">New</span>
                                        </a>
                                    </li>
                                    <li><a href="index-fifteen">
                                            <i class="fa-sharp fa-regular fa-chevron-right"></i>
                                            HR Website
                                            <span class="new-badge">New</span>
                                        </a>
                            ...
                            <div class="col-lg-3">
                                <ul class="mega-menu-item with-list parent-nav">
                                    ...
                                    <li><a href="index-seven"><i class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Business agency</a></li>
                                    <li><a href="index-eight"><i class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Business Management</a></li>
                                    <li><a href="index-nine"><i class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Insurance Home</a></li>
                                    <li><a href="index-ten"><i class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Business Website</a></li>
                                    <li><a href="index-eleven"><i class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Business Parallax</a></li>
                                    <li><a href="index-twelve"><i class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Business Video</a></li>
                                    <li><a href="index-fourteen">
                                            <i class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Accountent Two
                                            <span class="new-badge">New</span>
                                        </a>
                            ...
                            <div class="col-lg-3">
                                <ul class="mega-menu-item with-list parent-nav">
                                    ...
                                    <li><a href="onepage-one"><i class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Business One</a></li>
                                    <li><a href="onepage-two"><i class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Business Two</a></li>
                                    <li><a href="onepage-three"><i
                                                class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Business Three</a></li>
                                    <li><a href="onepage-four"><i class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Business Four</a></li>
                                    <li><a href="onepage-five"><i class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Finance Demo</a></li>
                                    <li><a href="onepage-six"><i class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Marketing agency</a></li>
                                    <li><a href="onepage-thirteen"><i
                                                class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Accountent One
                                            <span class="new-badge">New</span>
                                        </a>
                                    </li>
                                    <li><a href="onepage-fifteen">
                                            <i class="fa-sharp fa-regular fa-chevron-right"></i>
                                            HR Website Onepage
                                            <span class="new-badge">New</span>
                                        </a>
                            ...
                            <div class="col-lg-3">
                                <ul class="mega-menu-item with-list parent-nav">
                                    ...
                                    <li><a href="onepage-seven"><i
                                                class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Business agency</a></li>
                                    <li><a href="onepage-eight"><i
                                                class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Business Management</a></li>
                                    <li><a href="onepage-nine"><i class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Insurance Home</a></li>
                                    <li><a href="onepage-ten"><i class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Business Website</a></li>
                                    <li><a href="onepage-eleven"><i
                                                class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Business Parallax</a></li>
                                    <li><a href="onepage-twelve"><i
                                                class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Business Video</a></li>
                                    <li><a href="onepage-fourteen">
                                            <i class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Accountent Two
                                            <span class="new-badge">New</span>
                                        </a>
                ...
                <div class="wrapper">
                    <div class="container">
                        <div class="row g-0">
                            <div class="col-lg-3">
                                <ul class="mega-menu-item with-list parent-nav">
                                    <li><a href="about"><i class="fa-sharp fa-regular fa-chevron-right"></i>About
                                            Company</a></li>
                                    <li><a href="service"><i
                            ...
                            <div class="col-lg-3">
                                <ul class="mega-menu-item with-list parent-nav">
                                    ...
                                    <li><a href="contact"><i class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Contact</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-lg-3">
                                <ul class="mega-menu-item with-list parent-nav">
                                    ...
                                    <li><a href="blog-details-2"><i
                                                class="fa-sharp fa-regular fa-chevron-right"></i>Blog
                                            Details 02</a>
                                    </li>
                                    <li><a href="faq"><i class="fa-sharp fa-regular fa-chevron-right"></i>Faq's</a>
                                    <li><a href="career"><i
                                                class="fa-sharp fa-regular fa-chevron-right"></i>Career</a>
                                    </li>
                                    <li><a href="our-mission"><i
                            ...
                            <div class="col-lg-3">
                                <ul class="mega-menu-item with-list parent-nav">
                                    ...
                                    <li><a href="shop"><i class="fa-sharp fa-regular fa-chevron-right"></i>Shop</a>
                                    </li>
                                    <li><a href="shop-single"><i
                                                class="fa-sharp fa-regular fa-chevron-right"></i>Shop Details</a>
                                    </li>
                                    <li><a href="cart"><i class="fa-sharp fa-regular fa-chevron-right"></i>Cart</a>
                                    </li>
                                    <li><a href="chekout"><i
                                    ...
                                    <li><a href="coming-soon"><i
                                                class="fa-sharp fa-regular fa-chevron-right"></i>Coming Soon</a>
                                    </li>
                                    <li><a href="404"><i class="fa-sharp fa-regular fa-chevron-right"></i>404</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="row g-5">
                            ...
                            <div class="col-lg-4">
                                <ul class="mega-menu-item parent-nav">
                                    ...
                                    <li>
                                        <a href="contact" class="free-consultation">
                                            <div class="single-service-menu">
                                                <div class="info">
                        ...
                        <div class="row g-0">
                            <div class="col-lg-3">
                                <ul class="mega-menu-item with-list parent-nav">
                                    ...
                                    <li><a href="project-slider"><i
                                                class="fa-sharp fa-regular fa-chevron-right"></i>Project
                                            Slider</a></li>
                                    <li><a href="project-slider-2"><i
                                                class="fa-sharp fa-regular fa-chevron-right"></i>Project
                                            Slider 2</a></li>
                                    <li><a href="project-card-slider"><i
                                                class="fa-sharp fa-regular fa-chevron-right"></i>Project
                                            Card Slider</a></li>
                                    <li><a href="project-bg-dark"><i
                                                class="fa-sharp fa-regular fa-chevron-right"></i>Project
                                            Bg Dark</a></li>
                                </ul>
                            </div>
                            <div class="col-lg-3">
                                <ul class="mega-menu-item with-list parent-nav">
                                    ...
                                    <li><a href="project-grid"><i
                                                class="fa-sharp fa-regular fa-chevron-right"></i>Project
                                            Grid</a></li>
                                    <li><a href="project-grid-col-2"><i
                                                class="fa-sharp fa-regular fa-chevron-right"></i>Project
                                            Grid Col 2</a></li>
                                    <li><a href="project-slider-grid"><i
                                                class="fa-sharp fa-regular fa-chevron-right"></i>Grid Slider</a></li>
                                    <li><a href="project-slider-overflow"><i
                                                class="fa-sharp fa-regular fa-chevron-right"></i>Project Overflow</a>
                                    </li>
                                    <li><a href="project-grid-col-3"><i
                            ...
                            <div class="col-lg-3">
                                <ul class="mega-menu-item with-list parent-nav">
                                    ...
                                    <li><a href="project-details"><i
                                                class="fa-sharp fa-regular fa-chevron-right"></i>Project
                                            Detials</a>
                                    </li>
                                    <li><a href="project-details-2"><i
                                                class="fa-sharp fa-regular fa-chevron-right"></i>Project
                                            Detials
                                            Video</a>
                                    </li>
                                    <li><a href="project-details-3"><i
                                                class="fa-sharp fa-regular fa-chevron-right"></i>Project
                                            Detials
                                            Slider</a>
                                    </li>
                                    <li><a href="project-details-large-image"><i
                                                class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Large Image</a>
                                    </li>
                                    <li><a href="project-details-gallery"><i
                                                class="fa-sharp fa-regular fa-chevron-right"></i>
                                            Project Gallery</a>
                                    </li>
                                </ul>
...
<div class="loader-wrapper">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="blog-details-area-inner-content">
                        ...
                        <h2 class="title">Profitable business makes your profit</h2>
                        <p class="disc">
                        ...
                        <p class="disc">
                            ...
                            convallis, mollis vestibulum donec aliquam risus sapien ridiculus, nulla sollicitudin eget
                            in venenatis. Tortor montes platea iaculis posuere per mauris, eros porta blandit curabitur
                            ullamcorper varius
                        </p>
                        ...
                        <p class="disc">
                            ...
                            facilisis nunc ac quam, ad est cubilia mauris himenaeos nascetur vestibulum potenti, hac
                            purus magna.
                        </p>
                        <div class="thumbnail-large">
                            <img src="assets/images/blog/19.webp" alt="blog">
                        </div>
                        <h5 class="title mt--50">Ultimate Business Strategy Solution</h5>
                        <p class="disc">
                            Gravida maecenas lobortis suscipit mus sociosqu convallis, mollis vestibulum donec aliquam
                            risus sapien ridiculus, nulla sollicitudin eget in venenatis. Tortor montes platea iaculis
                            posuere per mauris, eros porta blandit curabitur ullamcorper varius nostra ante risus
                            egestas.
                        </p>
                        <div class="row align-items-center">
                            <div class="col-lg-5">
                                <div class="thumbnail details mb_sm--15"><img src="assets/images/blog/details/03.jpg"
                                        alt="finbiz_buseness">
                                </div>
                            </div>
                            <div class="col-lg-7">
                        ...
                        <p class="disc mt--50 mb--50">
                            Cubilia hendrerit luctus sem aptent curae gravida maecenas eleifend nunc nec vitae morbi
                            sodales fusce tristique aenean habitasse mattis sociis feugiat conubia mus auctor praesent
                            urna tincidunt taciti dui lobortis nullam. Mattis placerat feugiat ridiculus sed a per curae
                ...
                <div class="col-xl-4 col-md-12 col-sm-12 col-12 mt_lg--60 blog-list-style pl--30 pl_md--10 pl_sm--10">
                    ...
                    <div class="rts-single-wized Recent-post">
                        ...
                        <div class="wized-body">
                            ...
                            <div class="recent-post-single">
                                <div class="thumbnail">
                                    <a href="#"><img src="assets/images/blog/details/recent-post/02.png"
                                            alt="Blog_post"></a>
                                </div>
                                <div class="content-area">
                                    <div class="user">
                            ...
                            <div class="recent-post-single">
                                <div class="thumbnail">
                                    <a href="#"><img src="assets/images/blog/details/recent-post/03.png"
                                            alt="Blog_post"></a>
                                </div>
                                <div class="content-area">
                                    <div class="user">
                    ...
                    <div class="rts-single-wized contact">
                        ...
                        <div class="wized-body">
                            <h5 class="title">Need Help? We Are Here
                                To Help You</h5>
                            <a class="rts-btn btn-primary btn-white" href="contact">Contact Us</a>
                        </div>
                    </div>
                    <!-- single wized End -->
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="copyright-8-wrapper">
                            ...
                            <ul>
                                ...
                                <li><a href="terms-of-condition">Terms & Condition</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="rts-sidebar-menu-desktop">
        <a class="logo-1" href="index"><img class="logo" src="assets/images/logo/bigrabit.png" style="width: 25%;" alt="finbiz_logo"></a>
            ...
            <ul class="mainmenu metismenu" id="mobile-menu-active">
                <li class="has-droupdown">
                    ...
                    <ul class="submenu mm-collapse" style="height: 0px;">
                        <li><a href="index">Business One</a></li>
                        <li><a href="index-two">Business Two</a></li>
                        <li><a href="index-three">Business Three</a></li>
                        <li><a href="index-four">Business Four</a></li>
                        <li><a href="index-five">Finance Demo</a></li>
                        <li><a href="index-six">Marketing agency</a></li>
                        <li><a href="index-seven">Business agency</a></li>
                        <li><a href="index-eight">Business Management</a></li>
                        <li><a href="index-nine">Insurance Home</a></li>
                        <li><a href="index-ten">Business Website</a></li>
                        <li><a href="index-eleven">Business Parallax</a></li>
                        <li><a href="index-twelve">Business Video</a></li>
                        <li><a href="index-thirteen">Accountent One</a></li>
                        <li><a href="index-fourteen">Accountent Two</a></li>
                        <li><a href="index-fifteen">HR Website</a></li>
                    </ul>
                </li>
                <li class="has-droupdown">
                    <a href="#" class="main" aria-expanded="false">Onepage</a>
                    <ul class="submenu mm-collapse" style="height: 0px;">
                        <li><a href="onepage-one">Business One</a></li>
                        <li><a href="onepage-two">Business Two</a></li>
                        <li><a href="onepage-three">Business Three</a></li>
                        <li><a href="onepage-four">Business Four</a></li>
                        <li><a href="onepage-five">Finance Demo</a></li>
                        <li><a href="onepage-six">Marketing agency</a></li>
                        <li><a href="onepage-seven">Business agency</a></li>
                        <li><a href="onepage-eight">Business Management</a></li>
                        <li><a href="onepage-nine">Insurance Home</a></li>
                        <li><a href="onepage-ten">Business Website</a></li>
                        <li><a href="onepage-eleven">Business Parallax</a></li>
                        <li><a href="onepage-twelve">Business Video</a></li>
                        <li><a href="onepage-thirteen">Accountent One</a></li>
                        <li><a href="onepage-fourteen">Accountent Two</a></li>
                        <li><a href="onepage-fifteen">HR Website</a></li>
                    </ul>
                </li>
                <li class="has-droupdown">
                    ...
                    <ul class="submenu mm-collapse" style="height: 0px;">
                        ...
                        <li><a href="service-details">Service
                                Details</a>
                        </li>
                        <li><a href="service-details-2">Service
                                Details 2</a>
                        </li>
                        ...
                        <li><a href="team-details">Team
                                Details</a>
                        </li>
                        <li><a href="pricing">Pricing</a>
                        </li>
                        <li><a href="appoinment">Appoinment</a>
                        </li>
                        <li><a href="history">Our
                                History</a>
                        </li>
                        <li><a href="blog-list">Blog
                                List</a>
                        </li>
                        <li><a href="blog-grid">Blog
                                List</a>
                        </li>
                        <li><a href="blog-details">Blog
                                Details</a>
                        </li>
                        <li><a href="blog-details-2">Blog
                                Details 02</a>
                        </li>
                        <li><a href="faq">Faq's</a>
                        <li><a href="career">Career</a>
                        </li>
                        <li><a href="our-mission">Our
                                Mission</a>
                        </li>
                ...
                <li class="has-droupdown">
                    ...
                    <ul class="submenu mm-collapse" style="height: 0px;">
                        <li><a class="mobile-menu-link" href="service">Service</a></li>
                        <li><a class="mobile-menu-link" href="service-details">Service Details</a></li>
                        <li><a class="mobile-menu-link" href="service-details-2">Service Details 2</a></li>
                        <li><a class="mobile-menu-link" href="service-details-3">Service Details 3</a></li>
                        <li><a class="mobile-menu-link" href="service-details-4">Service Details 4</a></li>
                        <li><a class="mobile-menu-link" href="service-details-5">Service Details 5</a></li>
                ...
                <li class="has-droupdown">
                    ...
                    <ul class="submenu mm-collapse">
                        ...
                        <li><a href="project-slider">Project
                                Slider</a></li>
                        <li><a href="project-slider-2">Project
                                Slider 2</a></li>
                        <li><a href="project-card-slider">Project
                                Card Slider</a></li>
                        <li><a href="project-bg-dark">Project
                                Bg Dark</a></li>
                        <li><a href="project-grid">Project
                                Grid</a></li>
                        <li><a href="project-grid-col-2">Project
                                Grid Col 2</a></li>
                        <li><a href="project-slider-grid">Grid Slider</a></li>
                        <li><a href="project-slider-overflow">Project Overflow</a>
                        </li>
                        <li><a href="project-grid-col-3">Project Grid Col 3</a>
                        </li>
                        <li><a href="project-bg-dark">Project
                                Hide Content</a></li>
                ...
                <li>
                    <a href="contact" class="main" aria-expanded="false">Contact Us</a>
                </li>
            </ul>
        </nav>
