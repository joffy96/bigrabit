...
<body class="color-yellow-demo onepage">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="header-main-one-wrapper">
                            <div class="thumbnail">
                                <a href="index">
                                    <img src="assets/images/logo/07.svg" alt="finbiz-logo">
                                </a>
                            </div>
    ...
    <div class="rts-banner-area banner-accountent-bg rts-section-gap bg_image" id="home">
        <div class="container">
    ...
    <div class="why-chooseus-area rts-section-gapBottom" id="about">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 pr--30">
                    <div class="thumbnail-accountent-why-choose">
                        <img src="assets/images/why-choose/11.webp" alt="why-chooseus-area">
                ...
                <div class="col-lg-6 pl--50 pl_sm--10 mt_md--50 mt_sm--50 pb_md--50 pb_sm--40">
                    <div class="why-choose-8-wrapper-content">
                        <div class="title-style-five mb--40">
                            ...
                            <h2 class="title rts-text-anime-style-1">We know how to manage
    ...
    <div class="contactform-accountentarea rts-section-gap bg_image" id="contact">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
