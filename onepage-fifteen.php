...
<body class="color-blue-demo onepage">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="header-main-one-wrapper">
                            <div class="thumbnail">
                                <a href="index">
                                    <img src="assets/images/logo/08.svg" alt="finbiz-logo">
                                </a>
                            </div>
    ...
    <div class="banner-service-wrapper-bg" id="home">
    ...
    <div class="rts-business-process-area rts-section-gap">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 mt_sm--30 mt_md--50">
    ...
    <div class="rts-footer-area in-green-demo with-hr-demo footer-three rts-section-gapTop footer-bg-2">
