...
<body class="onepage">
        ...
        <div class="main-header">
            <div class="content">
                <div class="header-left">
                    <a class="thumbnail" href="index">
                        <img src="assets/images/logo/bigrabit.png" style="width: 25%;" alt="logo">
                    </a>
                    <div class="nav-area">
                        <ul>
                ...
                <div class="header-right">
                    ...
                    <a class="rts-btn btn-primary" href="#">Book a Meeting</a>
                    <button id="menu-btn" class="menu menu-btn rts-btn btn-primary btn-white ml--20">
                        <img class="menu-dark" src="assets/images/icons/menu.png" alt="Menu-icon">
                        <img class="menu-light" src="assets/images/icons/menu-light.png" alt="Menu-icon">
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="banner-three-box-clip-area" id="home">
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
                    <div class="banner-inner-conten">
                        ...
                        <a href="appoinment" class="rts-btn btn-primary">View Solutions</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="rts-service-area rts-section-gap" id="service">
        <div class="container">
            ...
            <div class="row g-5 mt--10">
                <div class="col-lg-3 col-md-6 col-sm-6" data-animation="fadeInUp" data-delay="0.2" data-duration="1.2">
                    <div class="single-service-style-three">
                        <div class="inner">
                            ...
                            <a class="read-more" href="service-details">Learn More <i
                                    class="fa-light fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6" data-animation="fadeInUp" data-delay="0.4" data-duration="1.2">
                    <div class="single-service-style-three">
                        <div class="inner">
                            <div class="icon">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6" data-animation="fadeInUp" data-delay="0.6" data-duration="1.2">
                    <div class="single-service-style-three">
                        <div class="inner">
                            <div class="icon">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6" data-animation="fadeInUp" data-delay="0.8" data-duration="1.2">
                    <div class="single-service-style-three">
                        <div class="inner">
                            <div class="icon">
                            ...
                            <a class="read-more" href="service-details">Technology Solutions <i
                                    class="fa-light fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
    ...
    <div class="rts-about-area rts-section-gap" id="about">
            ...
            <div class="row g-5 mt--20 align-items-center rts_jump_animation-wrapper">
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 rts-jump__item">
                    ...
                    <div class="rts-working-process-1 text-center">
                        <div class="inner">
                            <div class="icon">
                                <img src="assets/images/wokring-process/icon/bigrabit.png" alt="Working_process">
                            </div>
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-6">
                    <div class="why-choose-us-three-content-left">
                        ...
                        <div class="why-choose-feature">
                            <div class="single">
                                <div class="icon">
                                    <img src="assets/images/why-choose/bigrabit.png" alt="">
                                </div>
    ...
    <div class="rts-case-studies-area rts-section-gapBottom" id="project">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-style-three center">
            ...
            <div class="row g-5 mt--10 rts_jump_animation-wrapper">
                <div class="col-lg-6 rts-jump__item">
                    <div class="single-project-style-three">
                        <a href="project-details" class="thumbnail">
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="rts-client-reviews-h2">
                                    <div class="review-header">
                                        <a href="#" class="thumbnail">
                                            <img src="assets/images/testimonials/avatar/01.webp"
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="rts-client-reviews-h2">
                                    <div class="review-header">
                                        <a href="#" class="thumbnail">
                                            <img src="assets/images/testimonials/avatar/02.webp"
                                                alt="testimonials_area">
                                        </a>
                                        <div class="discription">
                                            <a href="#">
                ...
                <div class="col-lg-4 col-md-6" data-animation="fadeInUp" data-delay="0.0" data-duration="1.2">
                    ...
                    <div class="rts-blog-h-2-wrapper">
                        ...
                        <div class="body">
                            ...
                            <a class="rts-read-more btn-primary" href="blog-details"><i
    ...
    <div class="rts-footer-area ptb--100 footer-three footer-bg-three mt--120 mt_md--80 mt_sm--60" id="contact">
        <div class="container">
            <div class="row">
                <!-- single wized -->
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 mt_sm--50">
                    <div class="footer-two-single-wized two">
                        ...
                        <div class="wized-2-body">
                            <ul>
                                <li><a href="service-details"><i class="fal fa-chevron-double-right"></i>Business
                                        planning</a></li>
                                <li><a href="service-details"><i class="fal fa-chevron-double-right"></i>Tax
                                        strategy</a></li>
                                <li><a href="service-details"><i class="fal fa-chevron-double-right"></i>Financial
                                        advices</a></li>
                                <li><a href="service-details"><i class="fal fa-chevron-double-right"></i>Insurance
                                        strategy</a></li>
                                <li><a href="service-details"><i class="fal fa-chevron-double-right"></i>Manage
                                        investment</a></li>
                            </ul>
                        </div>
                    </div>
