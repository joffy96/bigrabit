    ...
    <div class=" rts-section-gapBottom">
         <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <ul>
                        <li><strong>Cut-off Wristbands (B9):</strong> Detect if safety wristbands are cut or tampered with. Critical in enforcing compliance in high-risk areas.</li>
                        <li><strong>Emergency Buttons (B10):</strong> Provide miners a direct line of alert in case of cave-ins, gas leaks, or other underground emergencies.</li>
                        <li><strong>Gateways:</strong> Track personnel underground, collect safety data, and transmit it wirelessly to above-ground control rooms.</li>
                        <li><strong>Wristbands (B7):</strong> Help log exact times and zones miners enter and exit, supporting audits and emergency evacuation plans.</li>
                    </ul>
                ...
                <div class="col-lg-12">
                    <div class="project-details-main-inner">
                        <div class="project-details-thumbnail">
                            <img src="custom/16816.jpg" alt="Mining Solutions">
                        </div>
                    </div>
                </div>
            </div>
