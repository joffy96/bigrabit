...
<div class="loader-wrapper">
    ...
    <main class="ms-main">
        <div class="ms-page-content pt--65 pb--65">
            <!--================= Cart Area Start =================-->
                                ...
                                <tbody>
                                    <tr class="woocommerce-cart-form__cart-item cart_item">
                                        <td class="product-remove">
                                            <a href="#0" class="remove" aria-label="Remove this item" data-product_id="470" data-product_sku="161056">
                                        ...
                                        <td class="product-thumbnail">
                                            <a href="shop-single">
                                                <img src="assets/images/shop/shop-01.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="">
                                            </a>
                                        </td>
                                        <td class="product-name" data-title="Product">
                                            <a href="shop-single">Run Max 88</a>
                                        </td>
                                    ...
                                    <tr class="woocommerce-cart-form__cart-item cart_item">
                                        ...
                                        <td class="product-thumbnail">
                                            <a href="shop-single">
                                                <img src="assets/images/shop/shop-02.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="Shop Image">
                                            </a>
                                        </td>
                                        <td class="product-name" data-title="Product">
                                            <a href="shop-single">Workout Revolution 2</a>
                                        </td>
                                        <td class="product-price" data-title="Price">
                                            <span class="woocommerce-Price-amount amount">
                                    ...
                                    <tr class="woocommerce-cart-form__cart-item cart_item">
                                        <td class="product-remove">
                                            <a href="#0" class="remove" aria-label="Remove this item" data-product_id="478" data-product_sku="117652">
                                                <svg viewBox="0 0 200 200" width="18" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M114,100l49-49a9.9,9.9,0,0,0-14-14L100,86,51,37A9.9,9.9,0,0,0,37,51l49,49L37,149a9.9,9.9,0,0,0,14,14l49-49,49,49a9.9,9.9,0,0,0,14-14Z">
                                                    </path>
                                                </svg>
                                    ...
                                    <div class="ms-cart-collaterals cart-collaterals">
                                        <div class="ms-cart-totals cart_totals ">
                                            ...
                                            <div class="ms-proceed-to-checkout wc-proceed-to-checkout">
                                                <a href="#0" class="rts-btn btn-primary"> Proceed to checkout</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
