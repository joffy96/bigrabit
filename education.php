    ...
    <div class=" rts-section-gapBottom">
         <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <ul>
                        <li><strong>Wristbands (B7):</strong> Used for automated attendance, tracking student movements on campus, and ensuring classroom safety.</li>
                        <li><strong>Proximity Beacons:</strong> Trigger smart automation in classrooms (e.g., lights, AC) and send schedule or event notifications to students.</li>
                        <li><strong>Gateways:</strong> Aggregate data from BLE devices to log time-in/time-out records and help in campus security and analytics.</li>
                        <li><strong>Emergency Buttons (B10):</strong> Given to teachers and staff for immediate alerts during medical issues, fights, or lockdowns.</li>
                    </ul>
                ...
                <div class="col-lg-12">
                    <div class="project-details-main-inner">
                        <div class="project-details-thumbnail">
                            <img src="custom/innovative-futuristic-classroom-students.jpg" alt="Schools & Colleges Solutions">
                        </div>
                    </div>
                </div>
            </div>
