...
<head>
    ...
    <meta name="description"
        content="B9 Cut-off Alert Wristband">
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/fav.png">
    <title>Healthcare (Hospitals & Clinics)</title>
    ...
    <div class=" rts-section-gapBottom">
         <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <ul>
                        <li><strong>Wristbands (B7):</strong> Track patients and staff location, prevent unauthorized zone access, and help locate critical equipment.</li>
                        <li><strong>Cut-off Bands (B9):</strong> Monitor patients in isolation or psychiatric wards, triggering alerts if removed.</li>
                        <li><strong>Emergency Buttons (B10):</strong> Enable patients and healthcare workers to call for immediate assistance, improving emergency response.</li>
                        <li><strong>Gateways:</strong> Installed across the hospital to gather real-time data from all BLE devices for centralized monitoring and reporting.</li>
                        <li><strong>Proximity Beacons (MBM02):</strong> Guide visitors and staff across complex hospital layouts and deliver push notifications for navigation or health alerts.</li>
                    </ul>
