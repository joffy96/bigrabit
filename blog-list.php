            ...
            <div class="row g-5">
                ...
                <div class="col-xl-8 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="blog-single-post-listing" data-animation="fadeInUp" data-delay="0.2">
                        <div class="thumbnail">
                            <img src="assets/images/blog/14.webp" alt="Business-Blog">
                        </div>
                        <div class="blog-listing-content">
                            ...
                            <a class="blog-title" href="blog-details">
                            ...
                            <a class="rts-btn btn-primary" href="blog-details">Read Details</a>
                        </div>
                    </div>
                    <!-- single post End-->
                    <!-- single post -->
                    <div class="blog-single-post-listing" data-animation="fadeInUp" data-delay="0.3">
                        <div class="thumbnail">
                            <img src="assets/images/blog/15.webp" alt="Business-Blog">
                        </div>
                        <div class="blog-listing-content">
                            <div class="user-info">
                                <!-- single info -->
                            ...
                            <a class="blog-title" href="blog-details">
                                <h3 class="title animated fadeIn">Best Solution business makes your profit</h3>
                            </a>
                            <p class="disc">
                                Collaboratively pontificate bleeding edge resources with inexpensive methodologies
                                globally initiate multidisciplinary compatible architectures pidiously repurpose leading
                    ...
                    <!-- single post End-->
                    <!-- single post -->
                    <div class="blog-single-post-listing" data-animation="fadeInUp" data-delay="0.4">
                        <div class="thumbnail">
                            <img src="assets/images/blog/16.webp" alt="Business-Blog">
                        </div>
                        <div class="blog-listing-content">
                            <div class="user-info">
                                <!-- single info -->
                            ...
                            <a class="blog-title" href="blog-details">
                                <h3 class="title animated fadeIn">Marketing business makes your profit</h3>
                            </a>
                            <p class="disc">
                                Collaboratively pontificate bleeding edge resources with inexpensive methodologies
                                globally initiate multidisciplinary compatible architectures pidiously repurpose leading
                    ...
                    <!-- single post End-->
                    <!-- single post -->
                    <div class="blog-single-post-listing mb_sm--15" data-animation="fadeInUp" data-delay="0.2">
                        <div class="thumbnail">
                            <img src="assets/images/blog/17.webp" alt="Business-Blog">
                        </div>
                        <div class="blog-listing-content">
                            <div class="user-info">
                                <!-- single info -->
                            ...
                            <a class="blog-title" href="blog-details">
                                <h3 class="title animated fadeIn">Advantages Of business makes your profit</h3>
                            </a>
                            <p class="disc">
                                Collaboratively pontificate bleeding edge resources with inexpensive methodologies
                                globally initiate multidisciplinary compatible architectures pidiously repurpose leading
