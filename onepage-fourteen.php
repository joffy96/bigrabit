...
<body class="color-yellow-demo onepage">
    ...
    <div class="rts-banner-accountent-two rts-section-gap bg_image" id="home">
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 pr--30">
                    <div class="thumbnail-accountent-why-choose style-two">
                        <img src="assets/images/why-choose/12.webp" alt="why-chooseus-area">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonails-area-seven">
                                    <div class="thumbnail-testimoanis">
                                        <img src="assets/images/testimonials/09.webp" alt="testimonials">
                                    </div>
