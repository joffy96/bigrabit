...
<head>
    ...
    <meta name="description"
        content="B7 Wristband">
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/fav.png">
    <title>B7 Wristband</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-area-left center project-breadcrumb">
                        ...
                        <p class="disc">
                          The B7 Button Wristband is a lightweight Bluetooth wearable designed for real-time location tracking, safety monitoring, and indoor positioning. Ideal for schools, hospitals, factories, and event venues, it offers comfortable all-day use with an IP67 waterproof rating. Powered by BLE 5.0, it supports long battery life, customizable broadcast settings, and secure identification via UUID, Major, and Minor values. With tamper detection and optional NFC, it can be used for student check-ins, staff movement tracking, event crowd management, and geofencing alerts in high-risk zones. It works seamlessly with BLE gateways and compatible mobile apps for reliable personnel tracking.
                        </p>
                    </div>
                </div>
            </div>
