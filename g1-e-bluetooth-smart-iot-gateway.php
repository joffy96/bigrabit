...
<head>
    ...
    <meta name="description"
        content="G1-E Bluetooth Smart IoT Gateway">
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/fav.png">
    <title>G1-E Bluetooth Smart IoT Gateway</title>
                ...
                <div class="col-lg-12">
                    <div class="title-area-left center project-breadcrumb">
                        ...
                        <h1 class="title rts-text-anime-style-1">
                           G1-E Bluetooth Smart IoT Gateway
                        </h1>
                        <p class="disc">
                            The G1-E is an advanced Bluetooth Smart IoT Gateway. It is designed to collect data from Bluetooth Low Energy (BLE) devices and transmit it securely to cloud platforms like AWS Cloud. This gateway is built for enterprise environments and supports applications in warehousing, healthcare, retail, manufacturing, and smart buildings.
                        </p>
                    </div>
                </div>
            </div>
