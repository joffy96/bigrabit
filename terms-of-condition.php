                ...
                <div class="wrapper">
                    <div class="container">
                        <div class="row g-0">
                            ...
                            <div class="col-lg-3">
                                <ul class="mega-menu-item with-list parent-nav">
                                    <li><a href="team-details">Team Details</a>
                                    </li>
                            ...
                            <div class="col-lg-3">
                                <ul class="mega-menu-item with-list parent-nav">
                                    ...
                                    <li><a href="contact-2">Contact 2</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-lg-3">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-lg-3">
                                <ul class="mega-menu-item with-list parent-nav">
                                    ...
                                    <li><a href="project-details">Project
                                            Detials</a>
                                    </li>
                                    <li><a href="project-details-2">Project
                                            Detials
                                            Video</a>
                                    </li>
                                    <li><a href="project-details-3">Project
                                            Detials
                                            Slider</a>
                                    </li>
                                    <li><a href="project-details-large-image">Large Image</a>
                                    </li>
                                    <li><a href="project-details-gallery">Project Gallery</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
