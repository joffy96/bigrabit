...
<body class="onepage">
    ...
    <div class="rts-banner-area-eight banner-bg_eight bg_image" id="home">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner-inner-content-eight">
                        ...
                        <a href="service" class="rts-btn btn-primary">View Services</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="rts-service-area-start rts-sectiong-gap" id="service">
            ...
            <div class="row">
                <div class="col-lg-6 pr--30 pr_sm--10">
                    <section class="main-wrapper-sticky">
                        <div class="sticky-statement narrow">
                            ...
                            <div class="right">
                                <a href="service-details" class="arrow">
                ...
                <div class="col-lg-6">
                    <div class="title-style-one left mb--0 position-sticky top--120 mt_sm--40">
                        ...
                        <a href="service" class="rts-btn btn-primary">View All Service</a>
                    </div>
    ...
    <div class="rts-about-us-area-8 bg_primary rts-section-gapTop pb--100" id="about">
        <div class="container">
