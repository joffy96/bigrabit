...
<body class="onepage">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="inner-content-wrapper-four-banner">
                                            ...
                                            <div class="button-wrapper">
                                                <a href="contact" class="rts-btn btn-primary btn-white">Get
                                                    Started</a>
                                                <a href="contact" class="rts-btn btn-primary btn-border">Get
                                                    Started</a>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 rts-jump__item">
                    <div class="single-why-choose-four">
                        ...
                        <div class="inner-content">
                            <div class="icon">
                                <img src="assets/images/why-choose/icons/bigrabit.png" alt="why-choose">
                            </div>
                            <a href="#">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                                    <div class="pricing-wrapper-one">
                                        ...
                                        <div class="pricing-body">
                                            ...
                                            <!-- single pricing End -->
                                            <a class="rts-btn btn-primary btn-white" href="contact">Buy This</a>
                                        </div>
                                        <!-- pricing body end -->
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12 col-12 mt_sm--80">
                                    <div class="pricing-wrapper-one">
                                        ...
                                        <div class="pricing-body">
                                            ...
                                            <!-- single pricing End -->
                                            <a class="rts-btn btn-primary" href="contact">Buy This</a>
                                        </div>
                                        <!-- pricing body end -->
                                    </div>
                                </div>
    ...
    <div class="rts-appoinment-area rts-section-gapBottom" id="contact">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="single-blog-area-four">
                        ...
                        <div class="inner-content">
                            ...
                            <a href="blog-details" class="read-more">Read More <i
                                    class="fa-sharp fa-regular fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="footer-three-single-wized left">
                        <a href="index" class="logo_footer">
                            <img src="assets/images/logo/bigrabit.png" style="width: 25%;" alt="Logo-image">
                        </a>
