...
<body>
  <?php include "header.php"; ?>
    ...
    <div class="rts-breadcrumb-area" style="background-image: url('custom/shopping-malls.jpg');">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    <div class=" rts-section-gapBottom">
         <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p>
                        BiGRABiT’s IoT-powered proximity solutions are designed to transform shopping malls into smart, data-driven environments that enhance both customer experience and operational efficiency.
                    </p>
                    <p>
                    ...
                    <p>
                        Shoppers can receive personalized offers and location-based recommendations directly on their mobile devices, driving engagement and increasing sales. At the same time, real-time monitoring of crowd density improves safety and helps manage emergency evacuations.
                    </p>
                    <p>
                        With BiGRABiT’s centralized web application, mall operators gain valuable insights into customer behavior, store performance, and overall foot traffic trends — enabling smarter decisions, higher tenant satisfaction, and a seamless shopping experience for visitors.
                    </p>
                </div>
                </div>
            </div>
