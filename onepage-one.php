...
<body class="onepage">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    ...
                    <div class="rts-banner-area-two two rts-section-gap bg_image">
                        ...
                        <div class="shape-area-start">
                            <div class="shape shape-one">
                                <img src="assets/images/banner/shape/01.webp" alt="">
                            </div>
                            <div class="shape shape-two">
                                <img src="assets/images/banner/shape/02.webp" alt="">
                            </div>
                            <div class="shape shape-three">
                                <img src="assets/images/banner/shape/03.webp" alt="">
                            </div>
                            <div class="shape shape-four">
                                <img src="assets/images/banner/shape/04.webp" alt="">
                            </div>
                        </div>
                    </div>
                    <!-- rts banner area end -->
    ...
    <div class="rts-about-area-two rts-section-gap" id="about">
        ...
        <div class="shape-area">
            <img src="assets/images/about/shape/bigrabit.png" alt="shape" class="one">
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="single-service-signle-wrapper">
                                                    <div class="icons">
                                                        <img src="assets/images/service/icons/bigrabit.png" alt="service">
                                                    </div>
                                                    <div class="information">
                                                        ...
                                                        <a href="service-details" class="arrow-right">
            ...
            <div class="row g-5">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="single-counter">
                        <div class="icon">
                            <img src="assets/images/counterup/icon/bigrabit.png" alt="Business_counter">
                        </div>
    ...
    <!-- rts blog area start -->
    <div class="rts-blog-area rts-section-gapBottom pt--40 mb--310" id="blog">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-style-two center">
                ...
                <div class="col-xl-4 col-md-6 col-sm-12 col-12">
                    <div class="footer-one-single-wized mid-bg">
                        <div class="wized-title">
                            ...
                            <img src="assets/images/footer/bigrabit.png" alt="finbiz_footer">
                        </div>
