...
<div class="loader-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-area-left">
                        <span class="bg-title">Mission</span>
    ...
    <div class="rts-mission-image-page rts-section-gapBottom">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="thumbnail-mission" data-animation="fadeInUp" data-delay="0.1">
                        <img src="assets/images/mission/01.webp" alt="mission">
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="thumbnail-mission" data-animation="fadeInUp" data-delay="0.2">
                        <img src="assets/images/mission/02.webp" alt="mission">
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="thumbnail-mission" data-animation="fadeInUp" data-delay="0.3">
            ...
            <div class="row g-5">
                <div class="col-lg-4 col-md-6 col-sm-12" data-animation="fadeInUp" data-delay="0.2" data-duration="1.2">
                    <div class="signle-fun-facts-one">
                        <div class="icon">
                            <img src="assets/images/fun-facts/bigrabit.png" alt="fun-facts">
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="consultancy-style-one">
                        ...
                        <div class="signle-consultancy mb--30">
                            <div class="icon">
                                <img src="assets/images/about/icons/bigrabit.png" alt="">
                            </div>
