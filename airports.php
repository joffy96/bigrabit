...
<body>
  <?php include "header.php"; ?>
    ...
    <div class="rts-breadcrumb-area" style="background-image: url('custom/airports.png');">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    <div class=" rts-section-gapBottom">
        <div class="container">
            ...
            <div class="col-lg-12">
                <p>
                    BiGRABiT transforms airport operations by delivering IoT-based tracking and real-time management that ensure smoother passenger journeys, safer facilities, and more efficient staff operations. Passengers benefit from digital boarding passes, QR-based entry, and indoor navigation to check-in counters, lounges, gates, and baggage claims, reducing delays and confusion.
                </p>
                <p>
                    Airport authorities gain visibility into passenger flows, helping manage peak hours, minimize congestion, and allocate staff effectively. Ground equipment such as wheelchairs, trolleys, and service vehicles can be tracked to prevent misplacement and improve utilization.
                </p>
                <p>
                    Restricted zones such as runways, control rooms, or cargo areas are secured with proximity alerts, ensuring compliance with aviation safety norms. In emergencies like overcrowding, fire alarms, or unauthorized access, instant alerts enable faster response and evacuation. With dashboards and predictive analytics, BiGRABiT helps airports optimize resources, anticipate peak demands, and deliver safer, smoother journeys to millions of passengers.
                </p>
            </div>
