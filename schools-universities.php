...
<body>
  <?php include "header.php"; ?>
    ...
    <div class="rts-breadcrumb-area" style="background-image: url('custom/schools-universities.png');">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
...
<p>
    <strong>BiGRABiT</strong> strengthens student safety and institutional efficiency in educational environments through IoT-enabled monitoring and visitor management.
</p>
<p>
    Students wearing smart bands can be tracked in real time, with alerts triggered if they enter restricted zones such as labs, washrooms, or exits.
</p>
<p>
    Automated attendance and digital visitor passes simplify administration while keeping parents informed about student safety.
</p>
<p>
    Staff activities can also be monitored to ensure efficiency and availability during teaching hours. School resources such as projectors, lab equipment, and library materials can be tracked to prevent misplacement.
</p>
<p>
