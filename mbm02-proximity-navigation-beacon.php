...
<head>
    ...
    <meta name="description"
        content="MBM02 Proximity Navigation Beacon">
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/fav.png">
    <title>MBM02 Proximity Navigation Beacon</title>
                ...
                <div class="col-lg-12">
                    <div class="title-area-left center project-breadcrumb">
                        ...
                        <h1 class="title rts-text-anime-style-1">
                           MBM02 Proximity Navigation Beacon
                        </h1>
                        <p class="disc">
                    The MBM02 Proximity Navigation Beacon is a high-range Bluetooth device designed for indoor navigation and location-based notifications. With a broadcast range of up to 150 meters and up to 10 years of battery life, it’s perfect for use in museums, exhibitions, libraries, shopping malls, and large venues. It helps guide visitors, deliver push notifications, and support personalized content based on user location. The beacon features IP67 waterproof protection, a replaceable battery, and stable performance, making it ideal for long-term, low-maintenance deployments in smart retail, public spaces, and navigation systems.
                        </p>
                    </div>
                </div>
            </div>
