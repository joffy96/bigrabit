  ...
  <?php include "header.php"; ?>
    ...
    <div class=" rts-section-gapBottom">
        <div class="container">
            ...
            <div class="col-lg-12">
            <p>
                BiGRABiT enhances cultural institutions with IoT-driven visitor engagement, artifact protection, and operational efficiency. Visitors benefit from indoor navigation that guides them to exhibits, auditoriums, and amenities while personalized notifications provide exhibit details and event updates.
            </p>
            <p>
                For staff, real-time visibility improves security allocation, ensuring the right personnel are available when needed. Priceless artifacts and exhibition equipment can be tagged and tracked, preventing theft or misplacement while ensuring preservation. Restricted zone alerts protect archives and sensitive collections.
            </p>
            <p>
                In emergencies such as overcrowding or fire, instant alerts support faster evacuation and safety responses.
            </p>
            <p>
