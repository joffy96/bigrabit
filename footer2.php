                    ...
                    <div class="footer-one-single-wized">
                        ...
                        <div class="quick-link-inner">
                            ...
                            <ul class="links margin-left-70">
                                <li><a href="about"><i class="far fa-arrow-right"></i> About Us</a></li>
                                <li><a href="#"><i class="far fa-arrow-right"></i> My Account</a></li>
                                <li><a href="about"><i class="far fa-arrow-right"></i>Our Company</a></li>
                        ...
                        <div class="quick-link-inner d-block">
                            ...
                            <div class="signle-footer-contact-8">
                                ...
                                <div class="inner-content">
                                    ...
                                    <a href="mailto:sales@bigrabit.co.in">sales@bigrabit.co.in</a>
                                </div>
                            </div>
                            <div class="signle-footer-contact-8">
                                <div class="icon">
                                ...
                                <div class="inner-content">
                                    ...
                                    <a href="#">Unit No. 203, 2nd Floor, </br>
Building No. 6, Millennium Business Park,</br>Sector-3, Mahape, Navi Mumbai - 400710.</a>
                                </div>
                            </div>
                        </div>
                    </div>
