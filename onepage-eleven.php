...
<body class="full-screen-slider-demo">
    ...
    <header class="header-transparent in-full-screen header--sticky">
    ...
    <div class="full-screen-demo-swiper-main-wrapper">
        <div class="swiper mySwiper-full-screen-wrapper">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <!-- rts banner area start -->
                    <div
                        class="rts-banner-area-start-11 footer-area-full-screen bg_image six full-screen-height rts-section-gap">
                        <div class="container">
                            <div class="row pt--120 pt_sm--40">
                                <!-- single wized -->
                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="footer-two-single-wized left">
                                        ...
                                        <a class="rts-btn btn-primary btn-white" href="#">Get a Quote</a>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 mt_sm--15">
                                    <div class="footer-two-single-wized two">
                                        <div class="wized-title-area">
                                            <h5 class="wized-title">Our Services</h5>
                                            <img src="assets/images/footer/02.png" alt="Invena_Footer">
                                        </div>
                                ...
                                <div class="col-xl-2 col-lg-6 col-md-6 col-sm-12 col-12 mt_sm--30 mt_md--30">
                                    <div class="footer-two-single-wized d-sm--none">
                                        <div class="wized-title-area">
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="footer-two-single-wized right d-sm--none">
                                        <div class="wized-2-body">
                                            <div class="contact-info-1">
                                                <div class="icon">
