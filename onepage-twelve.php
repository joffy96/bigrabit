...
<body class="onepage">
    ...
    <div class="page-wrapper radious-none-button">
                        ...
                        <div class="col-lg-12">
                            <div class="banner-seven-inner-content">
                                <span class="pre-title">
                                    <img src="assets/images/banner/icon/bigrabit.png" alt="banner">
                                ...
                                <a href="service" class="rts-btn btn-primary btn-white">View
                                    Services</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-5 pl--30 mt_md--100 mt_sm--100">
                        <div class="about-6-inner-content-content">
                            ...
                            <a href="about" class="rts-btn btn-primary">About Us</a>
        ...
        <div class="rts-project-area rts-section-gap without-bg-image" id="project">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                                        <div class="pricing-wrapper-one">
                                            ...
                                            <div class="pricing-body">
                                                ...
                                                <!-- single pricing End -->
                                                <a class="rts-btn btn-primary btn-white" href="contact">Buy
                                                    This</a>
                                            </div>
                                            <!-- pricing body end -->
                                        </div>
