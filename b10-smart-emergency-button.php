...
<head>
    ...
    <meta name="description"
        content="B10 Smart Emergency Button!">
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/fav.png">
    <title>B10 Smart Emergency Button</title>
                ...
                <div class="col-lg-12">
                    <div class="title-area-left center project-breadcrumb">
                        ...
                        <h1 class="title rts-text-anime-style-1">
                           B10 Smart Emergency Button
                        </h1>
                        <p class="disc">
                          The B10 Smart Emergency Button is a compact, wearable Bluetooth device designed for quick emergency alerts and real-time tracking. It’s ideal for hospitals, factories, smart buildings, and public areas. With a single press, it sends a distress signal and provides vibration feedback. It offers up to 100 meters of wireless range, IP66-rated water and dust resistance, NFC for check-ins, and up to 60 days of battery life. The button is easy to wear, charges magnetically, and works with both Android and iOS devices, making it a reliable tool for safety, monitoring, and access control.
                        </p>
                    </div>
                </div>
            </div>
