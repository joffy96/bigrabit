...
<body class="index-one onepage">
    ...
    <div class="rts-banner-area banner-style-one bg_image" id="home">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    <div class="rts-latest-service-area rts-section-gapBottom" id="service">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                ...
                <div class="col-lg-12 mt--50">
                    <section class="main-wrapper-sticky">
                        <div class="sticky-statement">
                            <div class="left-side">
                                <div class="icon">
                                    <img src="assets/images/service/bigrabit.png" alt="service">
                                </div>
    ...
    <div class="boost-your-business-today mt--70" id="project">
