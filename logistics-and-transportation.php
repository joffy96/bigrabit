    ...
    <div class=" rts-section-gapBottom">
         <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <ul>
                        <li><strong>Asset Beacons (MBM02):</strong> Track parcels, pallets, or vehicles in transit. Log location, dwell times, and detect route deviations.</li>
                        <li><strong>Gateways:</strong> Installed in trucks and warehouses, they receive BLE signals from tagged cargo or workers and upload status live.</li>
                        <li><strong>Wristbands (B7/B9):</strong> Monitor loading/unloading crew for shift compliance, task allocation, and area-based permissions.</li>
                        <li><strong>Cut-off Bands (B9):</strong> Act as tamper-proof seals on high-value goods, sending alerts if removed or broken during shipping.</li>
                        <li><strong>Emergency Buttons (B10):</strong> Used by truck drivers or warehouse personnel to raise alarms during accidents, theft attempts, or delays.</li>
                    </ul>
