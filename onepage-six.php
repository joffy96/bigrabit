...
<body class="primary-blue">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="header-main-one-wrapper">
                            <div class="thumbnail">
                                <a href="index">
                                    <img src="assets/images/logo/05.svg" alt="finbiz-logo">
                                </a>
                            </div>
                            <div class="main-header">
                                ...
                                <div class="button-area">
                                    <button id="search"><i class="far fa-search"></i></button>
                                    <a href="contact"
    ...
    <!-- banner area start -->
    <div class="rts-banner-area-six rts-section-gapTop pb--90 bg_banner-five bg_image" id="home">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner-content-six">
                        ...
                        <div class="right-stars-area">
                            ...
                            <div class="button-wrapper">
                                <a href="contact" class="rts-btn btn-primary">Get In Touch</a>
                                <a href="about" class="rts-btn btn-primary">Learn More</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="rts-about-area-start-six rts-section-gap" id="about">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="cta-main-wrapper-six">
                        ...
                        <a href="contact" class="rts-btn btn-primary">Lets Work Together</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="rts-business-goal-area-wrapper-6 rts-section-gap">
        <div class="container">
            <div class="row">
                ...
                <div class="row g-5 mt--10 align-items-center">
    ...
    <div class="rts-project-area-main-wrapper rts-section-gapBottom" id="project">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-between-area">
                        ...
                        <a href="project" class="rts-btn btn-primary">View Project</a>
                    </div>
                </div>
            </div>
    ...
    <div class="rts-footer-area footer-six bg_image rts-section-gapTop bg-footer-one" id="contact">
                        ...
                        <div class="post-wrapper">
                            ...
                            <div class="single-footer-post mb--30">
                                ...
                                <div class="post-right">
                                    ...
                                    <a class="red-more" href="blog-details">Read More<i
