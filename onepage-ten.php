...
<body class="onepage">
    ...
    <div class="rts-banner-ten-area banner-bg_12 bg_image rts-section-gap" id="home">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner-inner-content-12">
                        <p class="pre">
                            <img src="assets/images/banner/icon/bigrabit.png" alt="">
                        ...
                        <div class="button-wrapper">
                            ...
                            <a href="about" class="rts-btn btn-primary btn-border">Learn More</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- service area start -->
    <div class="our-service-area-start rts-section-gap" id="service">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="rts-service-main-wrapper-10">
                        <div class="signle-service-style-10">
                            <div class="content-area-wrapper">
                                ...
                                <a href="service-details" class="arrow-right-btn">Learn More <i
    ...
    <div class="rts-projects-area-start-10 bg_images rts-section-gap" id="project">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-style-10">
                                    ...
                                    <div class="pricing-list-style-wrapper">
                                        <div class="single-list-pricing-area" data-animation="fadeInUp" data-delay="0.0"
                                            ...
                                            <div class="feature-button-wrapper">
                                                ...
                                                <a href="contact" class="rts-btn btn-primary btn-white">Buy
                                                    This</a>
                                            </div>
                                        </div>
                                        <div class="single-list-pricing-area" data-animation="fadeInUp" data-delay="0.0"
    ...
    <!-- footer area start -->
    <div class="footer-8-area-bg bg_image pt--65" id="contact">
